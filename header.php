...
$logo_svg = '<svg focusable="false" aria-hidden="true" width="50" height="40" viewbox="0 0 86 66" xmlns="http://www.w3.org/2000/svg">
                        ...
                        if ( is_front_page() || is_home() ) { ?>
                           ...
                           <h1 class="site-title">
                                <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                                    <?php echo $logo_svg; ?><span class="title"><?php bloginfo( 'name' ); ?></span>
